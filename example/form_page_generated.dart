...
class _GestorFormPageState extends State<GestorFormPage> {
  ...
  void initState() {
    ...
    _sobrenomeController = TextEditingController(text: widget.gestor.sobrenome);
    _enderecoController = TextEditingController(text: widget.gestor.endereco);
    _cidadeController = TextEditingController(text: widget.gestor.cidade);
